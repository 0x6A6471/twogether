defmodule HitchedWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HitchedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HitchedWeb.Gettext, "errors", msg, opts)
    end
  end
